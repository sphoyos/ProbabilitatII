...
Sigui $(X,Y)$ un vector aleatori que sequeix una distribución normal bivariant amb paràmetres  $\mu_x,\mu_y\in\mathbb{R}$ y $\sigma_x,\sigma_y>0$ i $\rho \in [-1,1]$ amb la funció  de densitat definida en \@ref(eq:fxybinorm) corresponent a una distribució normal bivariant. La distribució condicional de $y$ donat que $X=x$  es una distribució normal amb la esperança i variància següent:
...
on $\beta_1= \frac {\sigma_{XY}}{\sigma_X^2}$ i $\beta_0=\mu_Y-\mu_X \beta_1$
...
**Simulació d'una Normal Bivariant mitjançant la Descomposició de Cholesky**
 ...
 Assumim les dades del exemple  \@ref(exm:simnormbiv) on simulavem dades d'una distribució binormal
