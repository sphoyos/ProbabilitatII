...
Per obtenir la funció de densitat condicionada $f_{X|Y}$} només caldra dividir la funció de densitat conjunta respecta a la marginal



$$
f_{X|Y}(x)= \frac {f_{X,X} (x,y)} {f_Y(y)} = 
\begin{cases}
