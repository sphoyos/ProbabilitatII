...
{\centering \includegraphics[width=0.8\linewidth]{images/distbiv} 

}

\caption{Distribució continua bivariada}(\#fig:img-distbiv)
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{images/rectangle} 

}

\caption{Càlcul de la probabilitat d'un rectangle}(\#fig:img-rectangle)
\end{figure}
...
f_X(x_1,...,x_k)=
\begin{cases}
P(X_1=x_1,\ldots\X_k=x_k ), & \text{si } \mathbf{x}=(x_1,...,x_k) \in D_X \\
0, & \text{en la resta}
\end{cases}
$$
:::
...
{\centering \includegraphics[width=0.8\linewidth]{images/densconjunta} 

}

\caption{Funció de densitat conjunta bivariada}(\#fig:img-densconjunta)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{images/doubleintegral1} 

}

\caption{Double integral}(\#fig:img-doubleintegral1)
\end{figure}
...
![(\#fig:graf-triangle)Dues maneres d'obtenir la densitat conjunta  d'un triangle](images/graf-triangle-1.pdf) 
...
{\centering \includegraphics[width=0.8\linewidth]{images/doubleintegral2} 

}

\caption{Double integral}(\#fig:img-doubleintegral2)
\end{figure}
...
![(\#fig:density2)Funció de densitat f(x,y)](images/density2-1.pdf) 
:::
...
![(\#fig:graf-triangle2)Dues maneres d'obtenir la densitat conjunta  d'un triangle](images/graf-triangle2-1.pdf) 
...
![(\#fig:marginal)Funció de distribució marginal de Y mostral](images/marginal-1.pdf) 
...
![(\#fig:condicionada)Funció de distribució condicionada de Y en funció de X mostral](images/condicionada-1.pdf) 
...
{\centering \includegraphics{images/condicionada_joint} 

}

\caption{Exemple de distribució conjunta}(\#fig:img-condicionada2)
\end{figure}
...
{\centering \includegraphics{images/condicionada_Y} 

}

\caption{Exemple de distribució condicionada X|Y}(\#fig:img-condicionada3)
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{images/icecream_drowning} 

}

\caption{Correlació espúria entre el consum de gelats i morts per ofegament en aigua en USA}(\#fig:img-icecream)
\end{figure}
...
![(\#fig:graf-binormalrho)(ref:mititulo)](images/graf-binormalrho-1.pdf) 
...
![(\#fig:graf-binormalrho0)(ref:mititulo1)](images/graf-binormalrho0-1.pdf) 
...
{\centering \includegraphics[width=0.8\linewidth]{images/distnormalbivariant_marginal} 

}

\caption{Marginals de la distribució continua bivariant}(\#fig:img-distmargi)
\end{figure}
...
![](images/simulacio-bivariant-1.pdf)<!-- --> 
...
![](images/simulacio-cholesky-1.pdf)<!-- --> 
...
![(\#fig:graf-pbernoulli) Exemple  Compra botiga de roba  ](images/graf-pbernoulli-1.pdf) 
...
![(\#fig:unnamed-chunk-1)Exemple de procés del jugador arruïnat](images/unnamed-chunk-1-1.pdf) 
...
![(\#fig:graf-ppoisson)Exemple de nombre d'urgències per temps](images/graf-ppoisson-1.pdf) 
...
![(\#fig:graf-pgaussia)Exemple de nombre d'urgències per temps](images/graf-pgaussia-1.pdf) 
...
\begin{figure}
\includegraphics[width=1\linewidth]{images/graf-clima-1} \caption{Exemple de cadena de Markov del clima al poble}(\#fig:graf-clima)
\end{figure}
...
```
## Matriu de transició a 2 dies (P^2):
```
...
```
## Matriu de transició d'ací a 5 dies (P^5):
```
...
## Pluja 0.44792 0.35592 0.19616
```

```
## Vector de probabilitats d'ací a 5 dies (pi(5)):
```

```
##           Sol    Núvol    Pluja
## [1,] 0.451704 0.354812 0.193484
```

* **Probabilitat de Sol d'ací a 5 dies:** La probabilitat de tenir un dia assolellat és del **45.17%**(un valor de 0.4517). 
...
\begin{center}\includegraphics[width=0.7\linewidth]{../../../../AppData/Local/Temp/Rtmpc9kNjA/file638844d8e8} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{../../../../AppData/Local/Temp/Rtmpc9kNjA/file63884385551d} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{../../../../AppData/Local/Temp/Rtmpc9kNjA/file6388631788a} \end{center}
<br><br>
...
\begin{center}\includegraphics[width=0.7\linewidth]{../../../../AppData/Local/Temp/Rtmpc9kNjA/file63886e26ef9} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{../../../../AppData/Local/Temp/Rtmpc9kNjA/file638876471814} \end{center}
<br><br>
...
\begin{center}\includegraphics[width=0.7\linewidth]{../../../../AppData/Local/Temp/Rtmpc9kNjA/file63887061535e} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{../../../../AppData/Local/Temp/Rtmpc9kNjA/file63886c783bf} \end{center}
...
\includegraphics[width=1\linewidth]{../../../../AppData/Local/Temp/Rtmpc9kNjA/file638871aa4264} 
...
```
##   [1]  0 -1 -2 -1  0 -1  0 -1 -2 -3 -2 -3 -4 -3 -4 -3 -2 -3 -4 -3 -2 -1  0 -1  0
##  [26]  1  0 -1  0 -1  0 -1  0  1  2  1  0  1  0 -1 -2 -3 -4 -3 -2 -3 -2 -1  0  1
##  [51]  0 -1 -2 -1  0  1  0  1  0  1  2  3  2  1  2  1  2  3  2  1  2  1  0  1  2
##  [76]  3  2  3  2  1  2  1  0  1  2  1  0 -1 -2 -3 -4 -3 -4 -3 -2 -1 -2 -1  0  1
## [101]  0 -1 -2 -3 -2 -3 -2 -3 -4 -3 -4 -3 -2 -3 -2 -1 -2 -1  0 -1  0  1  0  1  0
## [126]  1  2  3  4  5  4  5  4  5  6  7  6  7  6  7  6  7  8  9 10 11 12 11 10 11
## [151] 10 11 10  9  8  9 10  9 10 11 12 11 12 11 10  9  8  9 10  9  8  9  8  7  8
## [176]  9 10 11 12 13 14 13 14 15 14 15 14 13 12 11 12 13 14 13 14 15 14 15 14 15
## [201] 14
```



\begin{center}\includegraphics{images/passeig-aleatori-1} \end{center}
:::
...
{\centering \includegraphics[width=0.6\linewidth]{images/unnamed-chunk-10-1} 

}

\caption{Representació gràfica de les funcions relacionades amb un procés de Poisson}(\#fig:unnamed-chunk-10)
\end{figure}
